...
/*   Updated: 2019/08/05 11:13:42 by ygarrot          ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
int		check_addr(t_ping *ping)
{
	...
	ping->host_addr =
		inet_ntoa(((t_sockaddr_in*)ping->host_entity->ai_addr)->sin_addr);
	ping->des =
		((t_sockaddr_in*)ping->host_entity->ai_addr)->sin_addr.s_addr;
